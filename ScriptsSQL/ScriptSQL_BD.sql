...
-- Schema ticket_flow
-- -----------------------------------------------------
-- DROP SCHEMA IF EXISTS `ticket_flow` ;
...
-- -----------------------------------------------------
-- Table `ticket_flow`.`genero`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ticket_flow`.`genero` ;

CREATE TABLE IF NOT EXISTS `ticket_flow`.`genero` (
...
CREATE TABLE IF NOT EXISTS `ticket_flow`.`usuario` (
  ...
  INDEX `fk_Usuario_Genero1` (`idGenero` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Usuario_Genero1`
    ...
    REFERENCES `ticket_flow`.`genero` (`idGenero`))
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8mb3;
